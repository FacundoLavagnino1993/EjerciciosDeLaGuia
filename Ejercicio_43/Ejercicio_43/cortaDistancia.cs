...
{
    class cortaDistancia:Colectivo
    {
        ...
        public cortaDistancia(string patente, string marca, double cantidadAsientos):base(patente,marca,cantidadAsientos)
        { }
       ...
       private Single calculaLlegada() 
        ...
        {
            Console.Clear();
            Console.WriteLine("\t\t\t        Viaje Corta Distancia");
