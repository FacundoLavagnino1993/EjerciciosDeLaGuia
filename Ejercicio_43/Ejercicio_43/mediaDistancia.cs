...
{
    class mediaDistancia:Colectivo
    {
        ...
        public mediaDistancia(string patente, string marca, double cantidadAsientos):base(patente,marca,cantidadAsientos)
        { }
        ...
        {
            Console.Clear();
            Console.WriteLine("\t\t\t        Viaje Media Distancia");
